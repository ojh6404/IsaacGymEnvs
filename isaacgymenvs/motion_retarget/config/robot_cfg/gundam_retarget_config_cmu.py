...
ROBOT_URDF_FILENAME = "assets/urdf/gundam/GGC_TestModel_rx78_20170112.urdf"
...
GUNDAM_ROOT_HEIGHT = 0.092
GUNDAM_CHEST_LENGTH = 0.128 + 0.025 + 0.3085   # [m]
GUNDAM_HAND_LENGTH = 1.0
GUNDAM_LEG_LENGTH = 0.122 + 0.01 + 0.38 + 0.38 + 0.04
