...
def main(urdf_model, motion_num, motion_file_path):
    """
    ...
    base_pos = motion_data['root_pos']
    base_quat = motion_data['root_rot']
    dof_pos = motion_data['dof_pos']
    base_lin_vel = motion_data['root_lin_vel']  # local
    base_ang_vel = motion_data['root_ang_vel']  # local
