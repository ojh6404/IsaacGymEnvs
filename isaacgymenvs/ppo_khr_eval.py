...
env = load_isaacgym_env_preview4(task_name="KHRRecovery")   # preview 3 and 4 use the same loader
env = wrap_env(env)
...
agent.load("/home/oh/isaac/IsaacGymEnvs/isaacgymenvs/runs/22-11-25_23-02-01-963281_PPO/checkpoints/agent_24000.pt")
